...
<div class="container mx-auto mt-20 px-6 bg-gradient-animation">
    ...
    <div class="flex justify-center items-center mb-12">
        <div class="bg-white shadow-lg rounded-3xl p-8 w-full max-w-4xl flex items-center space-x-8">
            ...
            <div class="flex-shrink-0">
                <img src="https://www.gravatar.com/avatar/{{ md5(auth()->user()->email) }}" alt="Profile" class="w-32 h-32 rounded-full border-4 border-indigo-500 shadow-xl">
            </div>
            <!-- User Info -->
            <div class="flex-grow">
    ...
    <div class="flex justify-center items-center space-x-6">
        ...
        <a href="{{ route('loans.eligibility') }}" class="bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold py-3 px-8 rounded-full shadow-xl transform hover:scale-105 hover:shadow-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-300 ease-in-out">
            Check Eligibility
        </a>
