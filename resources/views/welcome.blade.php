...
<body class="bg-gray-50">
    ...
    <header class="gradient-bg shadow-lg">
        <div class="container mx-auto px-6 py-4 flex items-center justify-between">
            <h1 class="text-2xl font-bold text-black header-font">LEGEND Bank</h1>
            ...
            <a href="{{ route('login') }}" class="bg-white text-blue-600 px-4 py-2 rounded-lg hover:bg-gray-100">Login</a>
        </div>
    </header>
    ...
    <div class="flex items-center justify-center min-h-screen gradient-bg floating-circles">
        ...
        <h1 class="text-5xl font-bold header-font mb-6">Banking with Integrity and Innovation</h1>
            ...
            <a
                        href="{{ route('register') }}"
                        class="bg-blue-600 text-white px-8 py-3 rounded-lg shadow-lg hover:bg-blue-700 transition duration-300 ease-in-out"
                    >
                        {{ __('Register here') }}
                    </a>
        </div>
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="relative group">
                <img src="./images/home7.jpg" alt="ABCD Skybanking" class="w-full h-48 object-cover rounded-lg">
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg opacity-0 group-hover:opacity-100 transition duration-300">
                    <h3 class="text-white font-bold text-xl">LEGEND Skybanking</h3>
                </div>
            </div>

            <!-- Service Item 2 -->
            <div class="relative group">
                <img src="./images/home7.jpg" alt="Offshore Banking" class="w-full h-48 object-cover rounded-lg">
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg opacity-0 group-hover:opacity-100 transition duration-300">
            ...
            <!-- Service Item 3 -->
            <div class="relative group">
                <img src="./images/home7.jpg" alt="Retail Loan" class="w-full h-48 object-cover rounded-lg">
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg opacity-0 group-hover:opacity-100 transition duration-300">
            ...
            <!-- Service Item 4 -->
            <div class="relative group">
                <img src="./images/home7.jpg" alt="Retail Deposit" class="w-full h-48 object-cover rounded-lg">
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg opacity-0 group-hover:opacity-100 transition duration-300">
            ...
            <div class="relative group">
                <img src="./images/home7.jpg" alt="Retail Deposit" class="w-full h-48 object-cover rounded-lg">
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg opacity-0 group-hover:opacity-100 transition duration-300">
                    <h3 class="text-white font-bold text-xl">LEGEND WOMEN BANKING</h3>
                </div>
            </div>
             ...
             <div class="relative group">
                <img src="./images/home7.jpg" alt="Retail Deposit" class="w-full h-48 object-cover rounded-lg">
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg opacity-0 group-hover:opacity-100 transition duration-300">
                    <h3 class="text-white font-bold text-xl">LEGEND SME LOAN</h3>
                </div>
            </div>
             <!-- Service Item 4 -->
             <div class="relative group">
                <img src="./images/home7.jpg" alt="Retail Deposit" class="w-full h-48 object-cover rounded-lg">
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg opacity-0 group-hover:opacity-100 transition duration-300">
                    <h3 class="text-white font-bold text-xl">LEGEND SME Deposit</h3>
                </div>
            </div>
        ...
        <div class="container mx-auto px-6 md:grid md:grid-cols-3 md:gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>Email: <a href="mailto:support@abcdbank.com" class="hover:text-gray-400">support@legendbank.com</a></li>
            ...
            <div>
                ...
                <ul class="flex space-x-4">
                    <li><a href="https://www.facebook.com/atikurr.seo" class="text-gray-400 hover:text-white">Facebook</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white">Twitter</a></li>
                    <li><a href="https://www.linkedin.com/in/atikurr-seo" class="text-gray-400 hover:text-white">LinkedIn</a></li>
                    <li><a href="https://www.instagram.com/atikurr_seo" class="text-gray-400 hover:text-white">Instagram</a></li>
                </ul>
            </div>
        </div>
        <!-- Copyright -->
